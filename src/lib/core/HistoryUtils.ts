...
export function compressImageData(imageData: ImageData): Uint16Array {
...
export function decompressImageData(compressed: Uint16Array, width: number, height: number): ImageData {
